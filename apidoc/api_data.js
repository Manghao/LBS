define({ "api": [
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "status",
            "description": "<p>Statut 404 NOT FOUND car la catégorie n'existe pas</p>"
          }
        ]
      }
    },
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "BadRequest",
            "description": "<p>L'heure de la commande est inférieure à la date courante.</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "delete",
    "url": "/commandes/:id/sandwichs/:id",
    "title": "Supprimer un sandwich d'une commande",
    "name": "deleteSandwichToCommande",
    "group": "Commande",
    "parameter": {
      "fields": {
        "Parameter": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "res",
            "description": "<p>String indiquant que le sandwich a bien été supprimé de la commande.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "SandwichNotFound",
            "description": "<p>Le <code>sandwich</code> à supprimer n'existe pas.</p>"
          }
        ]
      }
    },
